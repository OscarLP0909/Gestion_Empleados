...
exports.updateContractStatus = void 0;
...
const updateContractStatus = async () => {
    try {
        ...
        // ============================================
        const resultActivate = await Contract_js_1.Contract.updateMany({
            status: "APROBADO",
            startDate: {
                $gte: today,
                $lt: tomorrow
        ...
        // ============================================
        const resultFinalize = await Contract_js_1.Contract.updateMany({
            status: "ACTIVO",
            endDate: {
                $gte: today,
                $lt: tomorrow,
...
//# sourceMappingURL=contractStatusJob.js.map